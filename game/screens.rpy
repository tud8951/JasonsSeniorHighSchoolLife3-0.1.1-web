...
screen quick_menu():
    ...
    if quick_menu:
        ...
        hbox:
            ...
            textbutton _("标题菜单") action MainMenu() activate_sound "audio/yinxiao/03_button.wav"
            textbutton _("读取游戏") action ShowMenu("load") activate_sound "audio/yinxiao/03_button.wav"
            textbutton _("设置") action ShowMenu('preferences') activate_sound "audio/yinxiao/03_button.wav"
...
screen navigation():
    ...
    vbox:
        ...
        if main_menu:
            ...
            textbutton _("开始游戏") action Start() activate_sound "audio/yinxiao/03_button.wav"
...
screen main_menu():
    ...
    hbox:
        ...
        textbutton _("关于") action ShowMenu("about") activate_sound "audio/yinxiao/03_button.wav"

        textbutton _("退出") action Quit(confirm=not main_menu) activate_sound "audio/yinxiao/03_button.wav"
            ...
            grid gui.file_slot_cols gui.file_slot_rows:
                ...
                for i in range(gui.file_slot_cols * gui.file_slot_rows):
                    ...
                    button:
                        ...
                        textbutton _("删除") action Confirm(_("确定删除这个存档吗？"), FileDelete(slot)) style "slot_delete_button"
