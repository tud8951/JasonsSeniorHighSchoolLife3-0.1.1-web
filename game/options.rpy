...
define config.name = _("杰森的高中生活3 Demo")
...
define gui.about = _p("""
本游戏由 BigJackson 开发，欢迎前往 {a=https://www.bigjackson.vip}官网{/a}获取最新资讯。
\n剧情由BigJackson原创，根据真实事件改编，人物可能是虚构的，如有巧合，请勿当真。
\n素材提供感谢名单：韩林，蔡栩阳，豆包
\n- 未开发完毕，请前往{a=https://www.bigjackson.vip}官网{/a}查看进度
""")
...
define build.name = "JasonsSeniorHighSchoolLife3"
...
# define config.main_menu_music = "audio/111.mp3"
...
define config.save_directory = "JasonsSeniorHighSchoolLife3-1775913869"
