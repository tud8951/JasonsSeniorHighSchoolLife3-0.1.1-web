...
## 游戏内文本使用的字体。
define gui.text_font = "SourceHanSansCN-Medium.otf"

## 角色名称使用的字体。
define gui.name_text_font = "SourceHanSansCN-Medium.otf"

## 游戏外文本使用的字体。
define gui.interface_text_font = "SourceHanSansCN-Medium.otf"
...
define gui.idle_color = '#2b4450'  # 红色
define gui.hover_color = '#ffffff'  # 蓝色
